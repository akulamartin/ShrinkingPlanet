...
{
    const string privateCode = "xyqc2mI_q06KmNMWMFTfAw56ChHb_UI0a5Pz_grKSorw";  //Key to Upload New Info
    const string publicCode = "616f83628f40bba8b4e91cda";   //Key to download
